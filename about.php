...
<head>
    ...
    <title>Capital Karo || About</title>
    <?php
        ...
        <div class="container">
            ...
            <div class="testimonial-slider-two">
                ...
                <div class="testimonial-slider-two-item">
                    <div class="testimonial-slider-two-box">
                        <div class="testimonial-two-box-meta">
                            <img src="assets/images/testimonial/testimonial-1.png" alt="img">
                        ...
                        <p>
                            Capital Karo helped me launch my own loan brand with their white-label CRM. From setup to
                            operations, everything was seamless.
                        </p>
                        <span class="tagline">White-Label CRM Partner</span>
                        <div class="last-quote text-end"><i class="flaticon-quote-1"></i></div>
                    </div>
                </div>
                ...
                <div class="testimonial-slider-two-item">
                    <div class="testimonial-slider-two-box">
                        <div class="testimonial-two-box-meta">
                            <img src="assets/images/testimonial/testimonial-2.png" alt="img">
                            <div class="testimonial-two-membar">
                                <h5>Ankita Sharma</h5>
                        ...
                        <p>
                            Their CRM and support team make the loan process extremely smooth. I scaled my business 3× in one year.
                        </p>
                        <span class="tagline">Loan Sourcing</span>
                        <div class="last-quote text-end"><i class="flaticon-quote-1"></i></div>
                    </div>
                </div>
                ...
                <div class="testimonial-slider-two-item">
                    <div class="testimonial-slider-two-box">
                        <div class="testimonial-two-box-meta">
                            <img src="assets/images/testimonial/testimonial-3.png" alt="img">
                            <div class="testimonial-two-membar">
                                <h5>Manish Gupta</h5>
                        ...
                        <p>
                            The best CRM for DSA business! Real-time tracking, partner management, and support are excellent.
                        </p>
                        <span class="tagline">CRM User</span>
                        <div class="last-quote text-end"><i class="flaticon-quote-1"></i></div>
                    </div>
                </div>
